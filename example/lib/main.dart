...
import 'package:maplibre_navigation_flutter/embedded/controller.dart';
...
import 'package:maplibre_navigation_flutter/models/marker.dart';
...
import 'package:maplibre_navigation_flutter/views/banner_instruction.dart';
import 'package:maplibre_navigation_flutter/views/bottom_action.dart';
import 'package:maplibre_navigation_flutter/views/navigation_view.dart';
      ...
      builder:
          (_) => AddressInfo(
            ...
            buildRoute: () async {
              ...
              if (data.lat != null) {
                waypoints.add(
                  LatLng(data.lat?.toDouble() ?? 0, data.lng?.toDouble() ?? 0),
                );
              }
              _controller?.buildRoute(waypoints: waypoints);
              if (!mounted) return;
